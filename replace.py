...
def replace_in_file(file_path):
    ...
    try:
        ...
        old_text = '<meta content="noindex,nofollow" name="robots"/>'
        new_text = '<meta keywords="Unblocked Games, Play Free Games Online, Play instantly in fullscreen browser, no downloads, no ads, Explore and enjoy various gaming experiences now!">\n<link rel="icon" type="image/x-icon" href="https://unblockedgames-proxy-2.github.io/img/class-830.webp">'
